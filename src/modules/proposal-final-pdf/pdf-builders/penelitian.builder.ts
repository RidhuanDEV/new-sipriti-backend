...
/**
 * Build pdfmake TDocumentDefinitions for Template A — Kegiatan Penelitian.
 *
 * @param payload
 * @returns TDocumentDefinitions
 */
export const buildPenelitianDocDefinition = (payload: any): TDocumentDefinitions => {
  ...
  return {
    ...
    content: [
      ...
      buildOuterTable([
        ...
        // ── METODE PENELITIAN ───────────────────────────────────────────
        buildSectionLabelRow("METODE PENELITIAN"),
        [
          {
            stack: applyFirstLineIndent(
        ...
        // ── JADWAL PENELITIAN ───────────────────────────────────────────
        buildSectionLabelRow("JADWAL PENELITIAN"),
        [
          {
            stack: [
              buildJadwalTimelineTable(
